...
# importing other important modules to have access to them
import Functions # Functions.py file 
import GUI       # GUI.py file 


# Frame is the Tkinter frame class that or own class will inherit from 
class ParentWindow(Frame):
    def __init__(self, master, *args, **kwargs):
        ...
        Functions.center_window(self,700,00)
